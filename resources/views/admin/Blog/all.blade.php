            ...
            <button class="collapsenav bttttttn" style="font-size:20px;cursor:pointer;float: right;" onclick="openNav()">&#9776; </button>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('/blog/delete/'.$user->id) }}" class="btn btn-danger btn-sm">Delete</a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
                ...
                <div class="table-responsive">
                    <table class="table" id="restu_table">
                        ...
                        <tbody>
                            <?php $users = DB::table('posts')->whereNotNull('deleted_at')->get(); foreach($users as $user){  ?>
                            <tr>
                                <td><?php echo $user->id; ?></td>
                                <td><?php echo $user->title; ?></td>
                                <td>
                                    <!-- <a href="{{ url('/UserEdit'.'?id='.$user->id) }}" class="btn btn-success btn-sm">Edit</a> -->
                                    <a href="{{ url('/blog/restore/'.$user->id) }}" class="btn btn-danger btn-sm">Restore</a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
