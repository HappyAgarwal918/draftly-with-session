...
<div class="dashboard_txt2a">
            ...
            <button class="collapsenav bttttttn" style="font-size:20px;cursor:pointer;float: right;" onclick="openNav()">&#9776; </button>
                ...
                <?php $id = $_GET['id'];  $price = DB::table('price')->where('id', $id)->first(); ?>
                
                <form action="{{url('/PriceEdited')}}">
                    @csrf
                    <label for="old price" style="font-size: 20px; font-weight: bold;"><?php echo $price->policy; ?></label>
                    <input type="hidden" id="" name="id" value="<?php echo $id ?>" readonly="readonly"><br><br>
                    <div class="col" style="margin-left: 20px;">
                        <label for="old price" style="font-size: 20px">Old Price:</label>
                        <input type="text" id="" name="old_price" value="<?php echo $price->price; ?>" readonly="readonly" ><br><br>
                        <label for="new price" style="font-size: 19px">New Price:</label>
                        <input type="text" id="price" name="price"><br><br>
                    </div>
                    <div class="col">
                        <label for="old price" style="font-size: 20px">Old Deal_Price:</label>
                        <input type="text" id="" name="old_price" value="<?php echo $price->deal_price; ?>" readonly="readonly" ><br><br>
                        <label for="new price" style="font-size: 19px">New Deal_Price:</label>
                        <input type="text" id="price" name="deal_price"><br><br>
                    </div>
