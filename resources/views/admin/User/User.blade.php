...
<div class="dashboard_txt2a">
            ...
            <button class="collapsenav bttttttn" style="font-size:20px;cursor:pointer;float: right;" onclick="openNav()">&#9776; </button>
                ...
                <div class="form-group row mb-0" style="padding: 0px 0px 30px 20px">
                     <a href="{{url('/User/Register')}}" type="submit" class="btn btn-primary">
                            Add New User
                    </a>                               
                </div>
                ...
                <div class="table-responsive">
                    <table class="table" id="restu_table">
                        ...
                        <tbody>
                            ...
                            ->where('admin' , 0)->where('deleted_at' , null)
                            ->get(); foreach($users as $user){  ?>
                            <tr>
                                <td><?php echo $user->id; ?></td>
                                <td><?php echo $user->email; ?></td>
                                <td>
                                    <a href="{{ url('/UserEdit'.'?email='.$user->email) }}" class="btn btn-success btn-sm">Edit</a>
                ...
                <div class="table-responsive">
                    <table class="table" id="restu_table">
                        ...
                        <tbody>
                            <?php $users = DB::table('users')->where('admin' , 0)->whereNotNull('deleted_at')->get(); foreach($users as $user){  ?>
                            <tr>
                                <td><?php echo $user->id; ?></td>
                                <td><?php echo $user->email; ?></td>
                                <td>
                                    <a href="{{ url('/UserEdit'.'?email='.$user->email) }}" class="btn btn-success btn-sm">Edit</a>
                                    <a href="{{ url('/UserRestore/'.$user->id) }}" class="btn btn-danger btn-sm">Restore</a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
