            ...
            <button class="collapsenav bttttttn" style="font-size:20px;cursor:pointer;float: right;" onclick="openNav()">&#9776; </button>
                ...
                <div class="dashboard_txt2">
                    <form action="{{url('/logoupload')}}" method="POST" enctype="multipart/form-data">
                        @csrf                   
                     <div>
                            <label for="featured_image" style="float: left; padding: 15px 0px 0px 15px;"><b>Change Logo</b></label>
                            <input type="file" id="featured_image" name="featured_image" class="form-control" style="border: none !important" />
                     </div>
                     <div class="form-group text-center" style="float: left; padding: 10px 0px 0px 15px;">
