...
<html lang="en">
    ...
    <body class="session policies clauses">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <a href="custom-clause?form-id=<?php echo $id ?>"><button class="topa button">Create Clause</button></a>
                </div>
            </div>
        </div>
            ...
            <div class="table-responsive">
                <table class="table" id="restu_table">
                    ...
                    <?php $clauses = DB::table('custom-clause')->where('unique_id' , $id)->get(); 
                        ...
                        <tr>
                            <td><?php echo $clause->title; ?></td>
                            <td><span> <a data-html="Are you sure you want to delete this clause?" href="{{ url('/custom-clause-home/'.$clause->id) }}">Delete</a> </span></td>
                        </tr>
                    <?php } ?>
                    </tbody>
                </table>
