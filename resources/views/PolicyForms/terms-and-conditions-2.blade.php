...
@section('terms-and-conditions-2')
...
<html lang="en">
    <head>
        ...
        <script>
            ...
            window.dataLayer.push({ stVar3: 1 }, { event: "policiesWizard", eventCategory: "terms and conditions wizard", eventAction: "next step", eventLabel: "step 01 - general" });
        </script>
        ...
        <title>Create Terms and Conditions [Operating entity]</title>
            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-ms-12">
                        <div class="plugin-policies wizard tos step2 step_operator">
                            <div class="row">
                                <div class="col-ms-12">
                            ...
                            <form action="{{url('/terms-and-conditions-3')}}" method="post">
                                @csrf
                                ...
                                <fieldset>
                                    ...
                                    <div class="control hidden" id="control_edit_wizard_company_name">
                                        <div class="alert warning">
                                            This option is available only for premium terms and conditions.
                                            <a class="premium-switch" data-current-step="operator" href="qjDZgx15/2?set=premium">Click here</a> to change this policy to premium.
                                        </div>
                                    </div>

                                    <div class="control actions">
                                        <input class="button submit" type="submit" name="submit" value="Next" /> <a class="back" href="terms-and-conditions">Back</a>
                                    </div>
                                </fieldset>
