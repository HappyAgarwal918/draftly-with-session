            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-ms-12">
                        <div class="plugin-policies wizard disclaimer step12" id="policies-wizard-summary">
                            <div class="row">
                                <div class="col-ms-12">
                            ...
                            <form id="" action="<?php if(auth()->user()->admin == 1){ echo 'complete?form-id='.$id; } elseif($a->premium == 1 || $a->company == 1 || $a->specialty == 'fitness' || $a->specialty == 'financial' || $a->specialty == 'investments' || $a->specialty == 'medical' || $a->specialty == 'legal' || $a->accept == 1 || $a->affiliate_links_amazon == 1 || $a->ads == 1){ echo 'billing?form-id='.$id; } else{ echo "complete?form-id='.$id"; } ?>" method="post">
                                @csrf
                                <fieldset>
                                    <div class="control">
                                        <label for="input_edit_wizard_key">
                                            <strong>
                                            <?php if($a->platforms == 'Website URL' || $a->platforms == 'Mobile App Name') { echo $a -> platforms; }
                                            else { echo $a -> platforms_other; } ?>
                                            </strong>
                                        </label>
                                        ...
                                        <div class="field">                                 
                                          <?php if ($a->platforms = 'Mobile App Name'){ echo $a -> mobile_name; }
                                            ...
                                            if ($a->platforms_other = 'ebook Name'){ echo $a -> ebook_name; }
                                            if ($a->platforms_other = 'Landing Page') {echo $a -> landing_url;}
                                            if ($a->platforms_other = 'Course Name') { echo $a -> course_name;}
                                            if ($a->platforms_other = 'Podcast'){ echo $a -> podcast_name; }
                                            if ($a->platforms_other = 'Video Name'){ echo $a -> video_name; } ?>
                                        </div>
                                    </div>
                                    <div class="field">
                                        <?php if($a->premium == 1 || $a->company == 1 || $a->specialty == 'fitness' || $a->specialty == 'financial' || $a->specialty == 'investments' || $a->specialty == 'medical' || $a->specialty == 'legal' || $a->accept == 1 || $a->affiliate_links_amazon == 1 || $a->ads == 1){ ?>
                                    ...
                                    <div class="control">
                                        ...
                                        <div class="field">
                                            ...
                                            <span class="help">You will receive your disclaimer to this email address</span>
                                        </div>
                                        @error('email')
                                ...
                                <div class="control">
                                    ...
                                    <div class="control actions">
                                        <input class="button submit next" type="submit" name="submit" value="Create My Disclaimer" />
                                        <a class="back" href="disclaimer-11">Back</a>
                                    </div>
                                </fieldset>
