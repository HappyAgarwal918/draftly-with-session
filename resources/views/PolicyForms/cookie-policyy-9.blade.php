            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-ms-12">
                        <div class="plugin-policies wizard cookie step9" id="policies-wizard-summary">
                            <div class="row">
                                <div class="col-ms-12">
                            ...
                            <form action="<?php if(auth()->user()->admin == 1){ echo 'complete?form-id='.$id; } elseif($a->premium == 1 || $a->company == 1 || $a->ads == 1 || $a->cookies_ads_personal_info == 1 || $a->beacons == 1){ echo 'billing?form-id='.$id; } else{ echo "complete?form-id='.$id"; } ?>" method="post">
                                @csrf                                
                                <fieldset>
                                    <div class="control">
                                        ...
                                        <div class="field">
                                            <?php echo $a -> website_url; ?>
                                        </div>
                                    </div>
                                    <div class="field">
                                        <?php if($a->premium == 1 || $a->company == 1 || $a->ads == 1 || $a->cookies_ads_personal_info == 1 || $a->beacons == 1){ ?>
                                ...
                                <div class="control">
                                    ...
                                    <div class="control actions">
                                        <input class="button submit next" type="submit" name="submit" value="Create My Cookie Policy" />
                                        <a class="back" href="cookie-policyy-8">Back</a>
                                    </div>
                                </fieldset>
