...
@section('terms-and-conditions-9')
...
<script>
    ...
    window.dataLayer.push({ stVar3: 1 }, { event: "policiesWizard", eventCategory: "terms and conditions wizard", eventAction: "next step", eventLabel: "step 08 - clauses" });
</script>
...
<title>Create Terms and Conditions [Contact information]</title>
            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-ms-12">
                        <div class="plugin-policies wizard tos step9 step_contacts">
                            <div class="row">
                                <div class="col-ms-12">
                            ...
                            <form action="{{url('/terms-and-conditions-10')}}" method="post">
                                @csrf
                                ...
                                <fieldset>
                                    ...
                                    <div class="control actions">
                                        <input class="button submit next" type="submit" name="submit" value="Next" /> <a class="back" href="terms-and-conditions-8">Back</a>
                                    </div>
                                </fieldset>
