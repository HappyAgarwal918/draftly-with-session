...
@section('terms-and-conditions-11')
            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-ms-12">
                        <div class="plugin-policies wizard tos step11" id="policies-wizard-summary">
                            <div class="row">
                                <div class="col-ms-12">
                            ...
                            <form id="" action="<?php if(auth()->user()->admin == 1){ echo 'complete?form-id='.$id; } elseif($a->premium == 1 || $a->company == 1 || $a->sell == 1 || $a->ads == 1 || $a->misc_clauses == 'assignment' || $a->misc_clauses == 'warranty'){ echo 'billing?form-id='.$id; } else{ echo "complete?form-id='.$id"; } ?>" method="post">
                                @csrf
                                <fieldset>
                                    <div class="control">
                                ...
                                <div class="field">
                                    <?php if($a->premium == 1 || $a->company == 1 || $a->sell == 1 || $a->ads == 1 || $a->misc_clauses == 'assignment' || $a->misc_clauses == 'warranty'){ ?>
                                    ...
                                    <div class="control">
                                        ...
                                        <div class="field">
                                            ...
                                            <span class="help">You will receive your terms and conditions to this email address</span>
                                        </div>
                                        @error('email')
                                ...
                                <div class="control">
                                    ...
                                    <div class="control actions">
                                        <input class="button submit next" type="submit" name="submit" value="Create My Terms and Conditions" />
                                        <a class="back" href="terms-and-conditions-10">Back</a>
                                    </div>
                                </fieldset>
