    ...
    <head>
       ...
       <script async="" src="{{asset ('assets/js/app.js')}}" charset="UTF-8" crossorigin="*"></script>
        ...
        <script>
            ...
            window.dataLayer.push({ stVar3: 3 }, { event: "policiesWizard", eventCategory: "disclaimer wizard", eventAction: "next step", eventLabel: "step 01 - general" });
        </script>
        ...
        <title>Create Disclaimer [Operating entity]</title>
            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-ms-12">
                        <div class="plugin-policies wizard disclaimer step2 step_operator">
                            <div class="row">
                                <div class="col-ms-12">
                            ...
                            <form action="{{url('/disclaimer-3')}}" method="post">
                                @csrf
                             ...
                             <fieldset>
                                    ...
                                    <div class="control actions"><input class="button submit" type="submit" name="submit" value="Next" /> <a class="back" href="disclaimer">Back</a></div>
                                </fieldset>
