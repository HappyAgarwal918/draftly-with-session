            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-ms-12">
                        <div class="plugin-policies wizard refund step8" id="policies-wizard-summary">
                            <div class="row">
                                <div class="col-ms-12">
                            ...
                            <form id="payment_form" action="<?php if(auth()->user()->admin == 1){ echo 'complete?form-id='.$id; } elseif($a->premium == 1 || $a->sell == 'tangible' || $a->money_back == 0){ echo 'billing?form-id='.$id; } else{ echo "complete?form-id='.$id"; } ?>" method="post">
                                @csrf
                                <fieldset>
                                    <div class="control">
                                    ...
                                    <div class="field">
                                        <?php if($a->premium == 1 || $a->sell == 'tangible' || $a->money_back == 0){ ?>
                                ...
                                <div class="control">
                                    ...
                                    <div class="control actions">
                                        <input class="button submit next" type="submit" name="submit" value="Create My Refund Policy" />
                                        <a class="back" href="refund-policy-7">Back</a>
                                    </div>
                                </fieldset>
