...
@section('privacy-policy-14')

<!DOCTYPE html>
<!-- saved from url=(0045)bundle -->
<html lang="en">
    <head>
            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-ms-12">
                        <div class="plugin-policies wizard privacy step15" id="policies-wizard-summary">
                            <div class="row">
                                <div class="col-ms-12">
                            ...
                            <form id="" action="<?php if(auth()->user()->admin == 1){ echo 'complete?form-id='.$id; } elseif($a->premium == 1 || $a->company == 1 || $a->register_social == 1 || $a->teens == 1 || $a->sell == 1 || $a->affiliate_links == 1 || $a->ads == 1 || $a->remarketing == 1 || $a->info == 'identity' || $a->info == 'payment' || $a->purpose == 'sell_services' || $a->purpose == 'deliver_services' || $a->purpose == 'improve_services' || $a->purpose == 'send_promo' || $a->purpose == 'share_testimonials' || $a->purpose == 'show_ads' || $a->sell_a == 1 || $a->merger == 1){ echo 'billing?form-id='.$id; } else{ echo "complete?form-id='.$id"; } ?>" method="post">
                                @csrf
                                <fieldset>
                                    <div class="control">
                                    ...
                                    <div class="field">
                                        <?php if($a->premium == 1 || $a->company == 1 || $a->register_social == 1 || $a->teens == 1 || $a->sell == 1 || $a->affiliate_links == 1 || $a->ads == 1 || $a->remarketing == 1 || $a->info == 'identity' || $a->info == 'payment' || $a->purpose == 'sell_services' || $a->purpose == 'deliver_services' || $a->purpose == 'improve_services' || $a->purpose == 'send_promo' || $a->purpose == 'share_testimonials' || $a->purpose == 'show_ads' || $a->sell_a == 1 || $a->merger == 1){ ?>
                                ...
                                <div class="control">
                                    ...
                                    <div class="control actions">
                                        <input class="button submit next" type="submit" name="submit" value="Create My Privacy Policy" />
                                        <a class="back" href="privacy-policy-13">Back</a>
                                    </div>
                                </fieldset>
