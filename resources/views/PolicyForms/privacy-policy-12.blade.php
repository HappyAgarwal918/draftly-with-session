...
<html lang="en">
    <head>
        ...
        <script>
            ...
            window.dataLayer.push({ stVar3: 3 }, { event: "policiesWizard", eventCategory: "privacy policy wizard", eventAction: "next step", eventLabel: "step 11 - security" });
        </script>
        ...
        <title>Create Privacy Policy [Contact information]</title>
            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-ms-12">
                        <div class="plugin-policies wizard privacy step12 step_contacts">
                            <div class="row">
                                <div class="col-ms-12">
                                    <div class="progress green stripes">
                                        <div class="bar" style="width: 84.615384615385%;">
                            ...
                            <form action="{{url('/privacy-policy-13')}}" method="post">
                                @csrf
                                ...
                                <fieldset>
                                    ...
                                    <div class="control actions">
                                        <input class="button submit next" type="submit" name="submit" value="Next" /> <a class="back" href="privacy-policy-11">Back</a>
                                    </div>
                                </fieldset>
