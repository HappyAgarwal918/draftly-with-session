...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="dmca-policy-generator" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>Create Digital Millennium Copyright Act Policy</title>
            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-ms-12">
                        <div class="plugin-policies wizard dmca step1 step_general">
                            <div class="row">
                                <div class="col-ms-12">
                            ...
                            <form action="{{url('/dmca-policy-2')}}" method="post">
                                 @csrf
                                ...
                                <fieldset>
                                    ...
                                    <div class="control" id="control_edit_wizard_platforms">
                                        <label for="input_edit_wizard_platforms"> What will this DMCA policy be used for? </label>
                                    ...
                                    <div class="control hidden" id="control_edit_wizard_mobile_name" style="display: block;">
                                    ...
                                    <div class="control hidden" id="control_edit_wizard_website_url" style="display: none;">
                                    ...
                                    <div class="control" id="control_edit_wizard_premium">
                                        <label for="input_edit_wizard_premium"> Would you like to create a premium DMCA policy with additional clauses and provisions? </label>

                                        <div class="field">
                                            <div class="radio">
                                                <div class="item">
                                                    <input class="radio" id="input_edit_wizard_premium_1" type="radio" name="premium" value="1" />
                                                    <label for="input_edit_wizard_premium_1"> Yes, I would like to create a premium DMCA policy. </label>
                                                </div>
                                                <div class="item">
                                    ...
                                    <div class="control features hidden" id="control_box_wizard_features_premium" style="display: none;">
                                        <div class="features premium">
                                            ...
                                            <div class="row">
                                                ...
                                                <ul class="list-icons tick col-ms-12 col-sm-6">
                                                    ...
                                                    <li><a data-role="modal" data-src="#refund-modal" onclick="return false" href="dmca-policy#">100% money back guarantee</a></li>
                                                </ul>
                                            </div>
                                        ...
                                        <div id="refund-modal" class="refund-modal" style="display: none;">
                                            ...
                                            <ul class="buttons">
                                                <li><a onclick="$.fancybox.close(); return false;" class="button" href="dmca-policy#">Close</a></li>
                                            </ul>
                                        </div>
                                    </div>

                                    <div class="control features hidden" id="control_box_wizard_features_basic" style="display: block;">
