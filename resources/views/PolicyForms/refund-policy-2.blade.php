...
<script>
    ...
    window.dataLayer.push({ stVar3: 1 }, { event: "policiesWizard", eventCategory: "refund policy wizard", eventAction: "next step", eventLabel: "step 01 - general" });
</script>
...
<title>Create Return and Refund Policy [Operating entity]</title>
            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-ms-12">
                        <div class="plugin-policies wizard refund step2 step_operator">
                            <div class="row">
                                <div class="col-ms-12">
                                    <div class="progress green stripes">
                                        <div class="bar" style="width: 16.666666666667%;">
                            ...
                            <form action="{{url('/refund-policy-3')}}" method="post">
                                @csrf
                                <input type="hidden" name="csrf_token" value="c25077aa4a946cd8673eb455e99992cc" />
                                <fieldset>
                                    <div class="control" id="control_edit_wizard_company_name">
                                    ...
                                    <div class="control actions"><input class="button submit" type="submit" name="submit" value="Next" /> <a class="back" href="refund-policy">Back</a></div>
                                </fieldset>
