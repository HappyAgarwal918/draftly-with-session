  ...
  @section('acceptable-use-policy-2') 
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <script>
            ...
            window.dataLayer.push({ stVar1: 4 }, { stVar3: 4 }, { event: "policiesWizard", eventCategory: "acceptable use policy wizard", eventAction: "next step", eventLabel: "step 01 - general" });
        </script>
        ...
        <title>Create Acceptable Use Policy [Operating entity]</title>
            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-ms-12">
                        <div class="plugin-policies wizard aup step2 step_operator">
                            <div class="row">
                                <div class="col-ms-12">
                                    <div class="progress green stripes">
                                        <div class="bar" style="width: 9.0909090909091%;">
                            ...
                            <form action="{{url('/acceptable-use-policy-3?form-id='.$id)}}" method="post">
                                @csrf
                                <fieldset>
                                    ...
                                    <div class="control hidden" id="control_edit_wizard_company_name" style="display: none;">
                                        <div class="alert warning">
                                            This option is available only for premium acceptable use policy.
                                            <a class="premium-switch" data-current-step="operator" href="acceptable-use-policy/BlXkfhXD/2?set=premium">Click here</a> to change this policy to premium.
                                        </div>
                                    </div>

                                    <div class="control actions">
                                        <input class="button submit" type="submit" name="submit" value="Next" /> <a class="back" href="acceptable-use-policy">Back</a>
                                    </div>
                                </fieldset>
