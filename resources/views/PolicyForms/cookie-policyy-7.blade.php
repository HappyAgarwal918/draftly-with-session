    ...
    <head>
        ...
        <script async="" src="{{asset ('assets/js/app.js')}}" charset="UTF-8" crossorigin="*"></script>
         ...
         <script>
            ...
            window.dataLayer.push({ stVar3: 4 }, { event: "policiesWizard", eventCategory: "cookie policy wizard", eventAction: "next step", eventLabel: "step 06 - beacons" });
        </script>
        ...
        <title>Create Cookie Policy [Contact information]</title>
            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-ms-12">
                        <div class="plugin-policies wizard cookies step7 step_contacts">
                            <div class="row">
                                <div class="col-ms-12">
                            ...
                            <form action="{{url('/cookie-policyy-8')}}" method="post">
                            	@csrf
                                <input type="hidden" name="csrf_token" value="28476b7ef8215abd3380757296578ce6" />
                                <fieldset>
                                    ...
                                    <div class="control actions">
                                        <input class="button submit next" type="submit" name="submit" value="Next" /> <a class="back" href="cookie-policyy-6">Back</a>
                                    </div>
                                </fieldset>
