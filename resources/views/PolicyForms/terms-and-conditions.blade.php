...
<html lang="en">
    <head>
        ...
        <script>
            ...
            window.dataLayer.push({ stVar3: 1 });
        </script>
        ...
        <link rel="canonical" href="terms-and-conditions-generator" />
    ...
    <body class="guest create policies_wizard_tos index">
        ...
        <div class="section sub-hero">
            <div class="container">
                <div class="row">
                    <div class="col-ms-12">
                        <h1>Create terms and conditions</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-ms-12">
                        <div class="plugin-policies wizard tos step1 step_general">
                            <div class="row">
                                <div class="col-ms-12">
                            ...
                            <form action="{{url('/terms-and-conditions-2')}}" method="post">
                                @csrf
                                ...
                                <fieldset>
                                    ...
                                    <div class="control" id="control_edit_wizard_platforms">
                                        <label for="input_edit_wizard_platforms"> What will this terms and conditions be used for? </label>
                                    ...
                                    <div class="control" id="control_edit_wizard_premium">
                                        <label for="input_edit_wizard_premium"> Would you like to create a premium terms and conditions policy with additional clauses and provisions? </label>

                                        <div class="field">
                                            <div class="radio">
                                                <div class="item">
                                                    <input class="radio" id="input_edit_wizard_premium_1" type="radio" name="premium" value="1" />
                                                    <label for="input_edit_wizard_premium_1"> Yes, I would like to create a premium terms and conditions policy. </label>
                                                </div>
                                                <div class="item">
                                    ...
                                    <div class="control features hidden" id="control_box_wizard_features_premium">
                                        <div class="features premium">
                                            ...
                                            <div class="row">
                                                ...
                                                <ul class="list-icons tick col-ms-12 col-sm-6">
                                                    ...
                                                    <li><a data-role="modal" data-src="#refund-modal" onclick="return false" href="terms-and-conditions#">100% money back guarantee</a></li>
                                                </ul>
                                            </div>
                                        ...
                                        <div id="refund-modal" class="refund-modal" style="display: none;">
                                            ...
                                            <ul class="buttons">
                                                <li><a onclick="$.fancybox.close(); return false;" class="button" href="terms-and-conditions#">Close</a></li>
                                            </ul>
                                        </div>
                                    </div>
