...
@section('acceptable-use-policy-11')
...
<html lang="en">
    <head>
        ...
        <script>
            ...
            window.dataLayer.push({ stVar1: 4 }, { stVar3: 4 }, { event: "policiesWizard", eventCategory: "acceptable use policy wizard", eventAction: "next step", eventLabel: "step 10 - contacts" });
        </script>
        ...
        <title>Create Acceptable Use Policy [Changes and updates]</title>
            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-ms-12">
                        <div class="plugin-policies wizard aup step11 step_updates">
                            <div class="row">
                                <div class="col-ms-12">
                            ...
                            <form action="{{url('/acceptable-use-policy-12?form-id='.$id)}}" method="post">
                                @csrf
                                <input type="hidden" name="csrf_token" value="d3b6ed452d00faa4c2fb8fed7c624f41" />
                                <fieldset>
                                        ...
                                        <div class="field">
                                            <div class="radio">
                                                <div class="item">
                                                    ...
                                                    <label for="input_edit_wizard_notify_page"> Update the modification date at the bottom of the acceptable use policy page. </label>
                                                </div>
                                                <div class="item">
                                    ...
                                    <div class="control actions">
                                        <input class="button submit next" type="submit" name="submit" value="Next" /> <a class="back" href="acceptable-use-policy-10">Back</a>
                                    </div>
                                </fieldset>
