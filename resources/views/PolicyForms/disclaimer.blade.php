...
<html lang="en">
    <head>
        ...
        <link rel="alternate" type="application/rss+xml" title="Draftly.org Feed" href="blog/feed" />
        <link rel="canonical" href="disclaimer-generator" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>Create Disclaimer</title>
    ...
    <body class="guest create policies_wizard_disclaimer index">
            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-ms-12">
                        <div class="plugin-policies wizard disclaimer step1 step_general">
                            <div class="row">
                                <div class="col-ms-12">
                            ...
                            <form action="{{url('/disclaimer-2')}}" method="post">
                                @csrf
                                ...
                                <fieldset>
                                    ...
                                    <div class="control" id="control_edit_wizard_platforms">
                                        <label for="input_edit_wizard_platforms"> What will this disclaimer be used for? </label>
                                        ...
                                        <div class="field">
                                            <div class="radio">
                                                ...
                                                <!-- <div class="item">
                                                    <input class="radio" id="input_edit_wizard_platforms_mobile_website" type="radio" name="platforms" value="mobile_website" />
                                                    <label for="input_edit_wizard_platforms_mobile_website"> Both, this policy will be used for a mobile app and a website. </label>
                                                </div> -->
                                                <div class="item">
                                                    <input class="radio" id="input_edit_wizard_platforms_other" type="radio" name="platforms" value="Other" /> <label for="input_edit_wizard_platforms_other"> Something else </label>
                                                </div>
                                            </div>
                                        </div>
                                         @error('cookies_essential')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>

                                    <div class="control hidden" id="control_edit_wizard_platforms_other">
                                        <label for="input_edit_wizard_platforms_other"> Please clarify below </label>

                                        <div class="field">
                                            <div class="radio">
                                                <div class="item">
                                                    <input class="radio" id="input_edit_wizard_platforms_other_ebook" type="radio" name="platforms_other" value="ebook Name" /> <label for="input_edit_wizard_platforms_other_ebook"> eBook </label>
                                                </div>
                                                <div class="item">
                                                    <input class="radio" id="input_edit_wizard_platforms_other_landing" type="radio" name="platforms_other" value="Landing Page" />
                                                    <label for="input_edit_wizard_platforms_other_landing"> Landing page </label>
                                                </div>
                                                <div class="item">
                                                    <input class="radio" id="input_edit_wizard_platforms_other_course" type="radio" name="platforms_other" value="Course Name" />
                                                    <label for="input_edit_wizard_platforms_other_course"> Online course </label>
                                                </div>
                                                <div class="item">
                                                    <input class="radio" id="input_edit_wizard_platforms_other_podcast" type="radio" name="platforms_other" value="Podcast" />
                                                    <label for="input_edit_wizard_platforms_other_podcast"> Podcast </label>
                                                </div>
                                                <div class="item">
                                                    <input class="radio" id="input_edit_wizard_platforms_other_video" type="radio" name="platforms_other" value="Video Channel" />
                                                    <label for="input_edit_wizard_platforms_other_video"> Video channel </label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="control hidden" id="control_edit_wizard_mobile_name">
                                    ...
                                    <div class="control hidden" id="control_edit_wizard_website_url">
                                    ...
                                    <div class="control hidden" id="control_edit_wizard_course_name">
                                        <label for="input_edit_wizard_course_name"> What is the name of your online course or online training resource? </label>

                                        <div class="field">
                                            <input class="text col-ms-12 col-md-6" id="input_edit_wizard_course_name" maxlength="128" type="text" name="course_name" value="" />

                                            <span class="help">e.g. My Popular Online Course</span>
                                        </div>
                                    </div>

                                    <div class="control hidden" id="control_edit_wizard_landing_url">
                                        <label for="input_edit_wizard_landing_url"> What is the URL of your landing or sales page? </label>

                                        <div class="field">
                                            <input class="text col-ms-12 col-md-6" id="input_edit_wizard_landing_url" maxlength="128" type="text" name="landing_url" value="" />

                                            <span class="help">e.g. https://www.website.com/special-offer/</span>
                                        </div>
                                    </div>

                                    <div class="control hidden" id="control_edit_wizard_podcast_name">
                                        <label for="input_edit_wizard_podcast_name"> What is the name of your podcast? </label>

                                        <div class="field">
                                            <input class="text col-ms-12 col-md-6" id="input_edit_wizard_podcast_name" maxlength="128" type="text" name="podcast_name" value="" />

                                            <span class="help">e.g. My Podcast Show</span>
                                        </div>
                                    </div>

                                    <div class="control hidden" id="control_edit_wizard_ebook_name">
                                        <label for="input_edit_wizard_ebook_name"> What is the name of your eBook? </label>

                                        <div class="field">
                                            <input class="text col-ms-12 col-md-6" id="input_edit_wizard_ebook_name" maxlength="128" type="text" name="ebook_name" value="" />

                                            <span class="help">e.g. My eBook</span>
                                        </div>
                                    </div>

                                    <div class="control hidden" id="control_edit_wizard_video_name">
                                        <label for="input_edit_wizard_video_name"> What is the name of your video channel (such as those on YouTube)? </label>

                                        <div class="field">
                                            <input class="text col-ms-12 col-md-6" id="input_edit_wizard_video_name" maxlength="128" type="text" name="video_name" value="" />
                                    ...
                                    <div class="control" id="control_edit_wizard_premium">
                                        <label for="input_edit_wizard_premium"> Would you like to create a premium disclaimer with additional clauses and provisions? </label>

                                        <div class="field">
                                            <div class="radio">
                                                <div class="item">
                                                    <input class="radio" id="input_edit_wizard_premium_1" type="radio" name="premium" value="1" />
                                                    <label for="input_edit_wizard_premium_1"> Yes, I would like to create a premium disclaimer. </label>
                                                </div>
                                                <div class="item">
                                    ...
                                    <div class="control features hidden" id="control_box_wizard_features_premium">
                                        <div class="features premium">
                                            ...
                                            <div class="row">
                                                <ul class="list-icons tick col-ms-12 col-sm-6 no-margin-bottom">
                                                    <li>Suitable for businesses and commercial use</li>
                                        ...
                                        <div id="refund-modal" class="refund-modal" style="display: none;">
                                            ...
                                            <ul class="buttons">
                                                <li><a onclick="$.fancybox.close(); return false;" class="button" href="disclaimer#">Close</a></li>
                                            </ul>
                                        </div>

                                        <script>
                                            $(function () {
                                                $("#control_edit_wizard_platforms input.radio, #control_edit_wizard_platforms_other input.radio").click(function () {
                                                    setBasicInfoText();
                                                });
                                                setBasicInfoText();
                                            });
                                            function setBasicInfoText() {
                                                if ($("#input_edit_wizard_platforms_other").prop("checked")) {
                                                    $("#basic-policy-limits").html("FREE! Not suitable for commercial use (e.g. resources with ads or affiliate links and in the regulated field such as finance, legal, fitness, etc).");
                                                } else {
                                                    $("#basic-policy-limits").html("FREE! Not suitable for commercial use (websites and apps that display ads, have affiliate links, or accept payments of any kind and for any purpose).");
                                                }
                                            }
                                        </script>
                                    </div>
                                    ...
                                    <div class="control features hidden" id="control_box_wizard_features_basic">
                                        <div class="features basic">
                                            <div class="alert warning basic no-margin-bottom">
                                                <span id="basic-policy-limits">FREE! Not suitable for commercial use (websites and apps that display ads, have affiliate links, or accept payments of any kind and for any purpose).</span>
        ...
        <iframe src="./Create Disclaimer1_files/saved_resource(4).html" title="chat widget logging" style="display: none !important;"></iframe>
    </body>
</html>
