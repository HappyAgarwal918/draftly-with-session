...
<script>
    ...
    window.dataLayer.push({ stVar3: 3 });
        ...
        <title>Create Privacy Policy [Changes and updates]</title>
            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-ms-12">
                        <div class="plugin-policies wizard privacy step13 step_updates">
                            <div class="row">
                                <div class="col-ms-12">
                                    <div class="progress green stripes">
                                        <div class="bar" style="width: 92.307692307692%;">
                            ...
                            <form action="{{url('/privacy-policy-14')}}" method="post">
                                @csrf
                                ...
                                <fieldset>
                                        ...
                                        <div class="field">
                                            <div class="radio">
                                                <div class="item">
                                                    ...
                                                    <label for="input_edit_wizard_notify_page"> Update the modification date at the bottom of the privacy policy page. </label>
                                                </div>
                                                <div class="item">
                                    ...
                                    <div class="control actions">
                                        <input class="button submit next" type="submit" name="submit" value="Next" /> <a class="back" href="privacy-policy-12">Back</a>
                                    </div>
                                </fieldset>
