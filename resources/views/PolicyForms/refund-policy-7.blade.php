...
<script>
    ...
    window.dataLayer.push({ stVar3: 1 }, { event: "policiesWizard", eventCategory: "refund policy wizard", eventAction: "next step", eventLabel: "step 06 - services" });
</script>
...
<title>Create Return and Refund Policy [Contact information]</title>
            ...
            <div class="container">
                <div class="row">
                    <div id="content" class="col-ms-12">
                        <div class="plugin-policies wizard refund step7 step_contacts">
                            <div class="row">
                                <div class="col-ms-12">
                            ...
                            <form action="{{url('/refund-policy-8')}}" method="post">
                                @csrf
                                ...
                                <fieldset>
                                    ...
                                    <div class="control actions">
                                        <input class="button submit next" type="submit" name="submit" value="Next" /> <a class="back" href="refund-policy-6">Back</a>
                                    </div>
                                </fieldset>
