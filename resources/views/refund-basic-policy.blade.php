...
<html lang="en" class="cb-customize-desktop chrome">
    <head>
        ...
        <script>
            ...
            window.dataLayer.push({ stVar3: 1 }, { isLoggedIn: "true" }, { event: "policiesWizard", eventCategory: "refund policy wizard", eventAction: "complete questionnaire", eventLabel: "refund policy" });
        </script>
                            ...
                            <div class="content-view">
                                <div class="content-item frames policy-preview" data-role="tabs-frames">
                                    ...
                                    <div class="view" data-role="frame" data-frame="view" style="">
                                        ...
                                        <pre class="link"><code id="policy-public-link">http://policies.imbuetech.in/refund-basic-policy?form-id=<?php echo $id ?></code></pre>
                                        <ul class="buttons">
                                            <li>
                                                <a
                                            ...
                                            <li><a class="button" target="_blank" href="http://policies.imbuetech.in/refund-basic-policy?form-id=<?php echo $id ?>">View policy</a></li>
                                        </ul>
                                        <div class="row">
...
&lt;p&gt;If you would like to contact us to understand more about this Policy or wish to contact us concerning any matter relating to our use of cookies<?php if($bcd == 'form') { echo ', you may do so via the '; echo $a -> contact_form ;} ?><?php if($bcd == 'email') { echo ', send an email to '; echo $a -> contact_email ;} ?><?php if($bcd == 'address') { echo ', write a letter to '; echo $a -> contact_address ;} ?>&lt;/p&gt;<br>
